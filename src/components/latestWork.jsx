...
export default function LatestWork(props) {
  ...
  return (
    <>
      <div className=" font-[inter] text-center my-[6rem] px-4 sm:px-12 md:px-[3rem]  xl:px-[7.5rem] 2xl:px-[10rem]  ">
        <div className="">
      ...
      <div className="bg-[#28293e]">
        <div className="  px-4 sm:px-12 md:px-[3rem] xl:px-[7.5rem] 2xl:px-[10rem]  py-[5rem]">
          <div className=" relative ">
            <div className="  top-[-12rem]  grid sm:grid-cols-2 lg:grid-cols-3 w-full 2xl:gap-[2rem] gap-6">
              {lists.map((list) => (
